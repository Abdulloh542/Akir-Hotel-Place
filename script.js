...
const translations = {
    uz: {
        ...
        about_title: "AKIR Hotel",
        about_p1: "AKIR Hotel — Toshkent shahrining markazida joylashgan zamonaviy va qulay mehmonxona. Biz barcha mehmonlarimizga yuqori sifatli xizmat va shinamlikni kafolatlaymiz.",
        about_p2: "Biznes safarlar va oilaviy dam olish uchun ideal tanlov.",
        ...
        pool_p1: "AKIR Hotel mehmonlariga ochiq havoda suzish basseyni taqdim etadi. Issiq kunlarda salqinlaning va quyoshda dam oling.",
        ...
        gallery_subtitle: "AKIR Hotel bo'ylab virtual sayohat.",
        ...
        footer_desc: "AKIR Hotel — Toshkent shahridagi zamonaviy va qulay mehmonxona. Barcha mehmonlar uchun yuqori darajadagi xizmat.",
    ...
    ru: {
        ...
        about_title: "AKIR Hotel",
        about_p1: "AKIR Hotel — современный и комфортабельный отель, расположенный в центре Ташкента. Мы гарантируем высокое качество обслуживания и уют всем нашим гостям.",
        about_p2: "Идеальный выбор для деловых поездок и семейного отдыха.",
        ...
        pool_p1: "AKIR Hotel предлагает гостям открытый бассейн. Освежитесь в жаркие дни и отдохните на солнце.",
        ...
        gallery_subtitle: "Виртуальная экскурсия по AKIR Hotel.",
        ...
        footer_desc: "Современный и уютный отель в Ташкенте. Сервис высокого уровня для всех гостей.",
        footer_links: "Ссылки",
    ...
    en: {
        ...
        about_title: "AKIR Hotel",
        about_p1: "AKIR Hotel is a modern and comfortable hotel located in the heart of Tashkent. We guarantee high-quality service and comfort to all our guests.",
        about_p2: "The perfect choice for business trips and family vacations.",
        fact_wifi: "Free WiFi",
        ...
        pool_p1: "AKIR Hotel offers guests an outdoor swimming pool. Cool off on hot days and relax in the sun.",
        ...
        gallery_subtitle: "A virtual tour through AKIR Hotel.",
        g_exterior: "Exterior",
        g_room: "Room",
        ...
        footer_desc: "AKIR Hotel — a modern and comfortable hotel in Tashkent. High-level service for all guests.",
        footer_links: "Links",
